...
function Profile() {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="profile-container border-t border-gray-400">
        <div></div>
        <div className={`sidebar ${showSidebar ? "show-sidebar" : ""}`}>
          <span
            className="material-symbols-outlined close-menu-btn sidebar-back-btn"
          ...
          <ul className="side-nav">
            <li
              className={`side-nav-items ${tab === 1 ? "active-side-nav" : ""}`}
              onClick={() => {
                setTab(1);
            ...
            <li
              className={`side-nav-items ${tab === 2 ? "active-side-nav" : ""}`}
              onClick={() => {
                setTab(2);
                setShowSidebar(!showSidebar);
              }}
